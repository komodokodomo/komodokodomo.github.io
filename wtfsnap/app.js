...
//  console.log(objects.length);
 for(var i=0; i<objects.length ;i++){
  ...
  strokeWeight(5);
  noFill();
  button = uxRect((objects[i].bbox[0]/density)+objects[i].bbox[2]/(density*2),objects[i].bbox[1]/density+objects[i].bbox[3]/(2*density),objects[i].bbox[2]/density,objects[i].bbox[3]/density);
  button.uxRender();
