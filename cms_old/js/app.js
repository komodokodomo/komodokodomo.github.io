...
class lContainer {
    ...
    async lensChosenEvent(){
        ...
        if(APP_STATE.activeLens == this.uuid){
            ...
            updateClasslist(APP_STATE.project,APP_STATE.class,APP_STATE.activeLens);
...
function updateClasslist(x,y,z){
    if(!UTIL.quillChanged){
        ...
        console.log("before: ");
        console.log(APP_STATE.classJson[x]);

        APP_STATE.classJson[x][y].content[z].operation = UTIL.quill.getContents();
        UTIL.quill.setContents();  
        ...
        xhr.send(JSON.stringify(APP_STATE.classJson[x]));
        // xhr.send("update classList");
    }
}
    ...
    console.log("send API call to edit JSON file");
        ...
        Object.keys(APP_STATE.classJson[APP_STATE.project]).forEach(function(key) {
            ...
            if(APP_STATE.classJson[APP_STATE.project][key].content == null){
                ...
                APP_STATE.classJson[APP_STATE.project][key].content[n] = {"name": lensName, "emoji": "🧐", "operation": UTIL.quillBlankTemplate };
            }
            else{
...
async function addContentCloseEvent(){
    DOM_EL.opacityContainer.hide();
    DOM_EL.popupContainer.hide();
    DOM_EL.addContentContainer.hide();
