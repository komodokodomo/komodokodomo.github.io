...
//   }
  ...
  for (let i = 0; i < objects.length; i++) {
    ...
    if((w - (objects[i].x * w + objects[i].w * width))>w/5)   /// RIGHT
    {
        ...
        // noFill();
        fill(255,alpha);
        line((objects[i].x * width + objects[i].w * width)+w/10,   objects[i].y * h + objects[i].h * h/2 - objects[i].h * h/3,   objects[i].x * width + objects[i].w * width,   objects[i].y * height + objects[i].h * height/3);
        line((objects[i].x * width + objects[i].w * width)+w/10,   objects[i].y * h + objects[i].h * h/2 + objects[i].h * h/3,   objects[i].x * width + objects[i].w * width,   objects[i].y * height + objects[i].h * 2 * height/3);
