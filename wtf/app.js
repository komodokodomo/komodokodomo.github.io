...
//   }
  ...
  for (let i = 0; i < objects.length; i++) {
    if(objects[i].label == "keyboard" || objects[i].label == "bottle" || objects[i].label == "teddy bear"|| objects[i].label == "cup"){
    ...
    textSize(20);
    // textStyle();
    text("click on topics to find out more!", objects[i].x * width + objects[i].w * width/2,  objects[i].y * height + objects[i].h * height/2 +50);
    ...
    if((w - (objects[i].x * w + objects[i].w * width))>w/5)   /// RIGHT
    {
        ...
        rect((objects[i].x * width + objects[i].w * width)+w/10,   objects[i].y * h + objects[i].h * h/2 - objects[i].h * h/3,w/6,h/14,5);
        rect((objects[i].x * width + objects[i].w * width)+w/10,   objects[i].y * h + objects[i].h * h/2 + objects[i].h * h/3,w/6,h/14,5);
        noStroke();
        fill(20);
    ...
    if(objects[i].x * w>w/5) // LEFT
    {
        ...
        rect(objects[i].x * w - w/10, objects[i].y * h + objects[i].h * h/2 - objects[i].h * h/3,w/6,h/14,5);
        rect(objects[i].x * w - w/10, objects[i].y * h + objects[i].h * h/2 + objects[i].h * h/3,w/6,h/14,5);
        noStroke();
        fill(20);
    ...
    if(h - (objects[i].y * h + objects[i].h * h)>h/10)  //BOT
    {
        ...
        rect(3*w/10+50, objects[i].y * h + objects[i].h * h+h/20,w/6,h/14,5);
        rect(7*w/10-50, objects[i].y * h + objects[i].h * h+h/20,w/6,h/14,5);
        noStroke();
        fill(20);
    ...
    if(objects[i].y*h>h/10)  //TOP
    {
        ...
        rect(3*w/10+50, objects[i].y*h - h/20,w/6,h/14,5);
        rect(7*w/10-50, objects[i].y*h - h/20,w/6,h/14,5);
        noStroke();
        fill(20);
