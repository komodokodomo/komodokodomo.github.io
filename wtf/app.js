...
//   }
  ...
  for (let i = 0; i < objects.length; i++) {
    ...
    if(h - (objects[i].y * h + objects[i].h * h)>h/10)  //BOT
    {
        ...
        fill(255,alpha);
        // noFill();
        line(2*w/5, objects[i].y * h + objects[i].h * h+h/20,objects[i].x * w + objects[i].w * w/3, objects[i].y * h + objects[i].h * 7*h/8);
        line(3*w/5, objects[i].y * h + objects[i].h * h+h/20,objects[i].x * w + objects[i].w * 2*w/3, objects[i].y * h + objects[i].h * 7*h/8);
