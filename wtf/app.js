...
//   }
  ...
  for (let i = 0; i < objects.length; i++) {
    if(objects[i].label == "keyboard" || objects[i].label == "bottle" || objects[i].label == "teddy bear"|| objects[i].label == "laptop" || objects[i].label == "person"){
    ...
    if(h - (objects[i].y * h + objects[i].h * h)>h/10)  //BOT
    {
        ...
        fill(255,alpha);
        // noFill();
        line(3*w/10, objects[i].y * h + objects[i].h * h+h/20,objects[i].x * w + objects[i].w * w/3, objects[i].y * h + objects[i].h * 7*h/8);
        line(7*w/10, objects[i].y * h + objects[i].h * h+h/20,objects[i].x * w + objects[i].w * 2*w/3, objects[i].y * h + objects[i].h * 7*h/8);
        rect(3*w/10, objects[i].y * h + objects[i].h * h+h/20,w/5,h/10,5);
        rect(7*w/10, objects[i].y * h + objects[i].h * h+h/20,w/5,h/10,5);
        noStroke();
        fill(20);
        text(itemText[mode][0], 3*w/10, objects[i].y * h + objects[i].h * h+h/20);
        text(itemText[mode][0], 7*w/10, objects[i].y * h + objects[i].h * h+h/20);
    }
    if(objects[i].y*h>h/10)  //TOP
    {
        ...
        fill(255,alpha);
        // noFill();
        line(3*w/10,   objects[i].y*h - h/20,  objects[i].x * w + objects[i].w * w/3, objects[i].y * h + objects[i].h * h/8);
        line(7*w/10,   objects[i].y*h - h/20,  objects[i].x * w + objects[i].w * 2*w/3, objects[i].y * h + objects[i].h * h/8);
        rect(3*w/10, objects[i].y*h - h/20,w/5,h/10,5);
        rect(7*w/10, objects[i].y*h - h/20,w/5,h/10,5);
        noStroke();
        fill(20);
        text(itemText[mode][0], 3*w/10,objects[i].y*h - h/20);
        text(itemText[mode][0], 7*w/10,objects[i].y*h - h/20);
    }
